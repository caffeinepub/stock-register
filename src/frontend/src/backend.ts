...
export class Backend implements backendInterface {
    ...
    async addStockItem(arg0: string, arg1: string, arg2: bigint): Promise<void> {
    ...
    async getStockItem(arg0: string): Promise<StockItem> {
        if (this.processError) {
            try {
                const result = await this.actor.getStockItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeStockItem(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeStockItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStockItem(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStockItem(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
